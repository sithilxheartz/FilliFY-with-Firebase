...
//       fuelType:
//           data['fuelType'] ??
//           'Unknown', // Default value 'Unknown' if fuelType is null
//       addedQuantity:
//           data['addedQuantity']?.toDouble() ??
//           0.0, // Ensure it's a double, default to 0.0
//       date:
//           data['date'] ??
//           Timestamp.now(), // Default to current timestamp if date is null
//     );
//   }
// }
import 'package:cloud_firestore/cloud_firestore.dart';
